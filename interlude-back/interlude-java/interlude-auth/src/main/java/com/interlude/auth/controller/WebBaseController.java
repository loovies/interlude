...
public class WebBaseController {
    ...
    protected TokenUserInfoDto getTokenUserInfo() {
        ...
        TokenUserInfoDto gatewayUser = gatewayAuthHelper.getGatewayUser(attributes.getRequest());
        if (gatewayUser != null) {
            return gatewayUser;
        }

        return redisComponent.getWebToken(getTokenFromRequest(attributes.getRequest()));
    }
